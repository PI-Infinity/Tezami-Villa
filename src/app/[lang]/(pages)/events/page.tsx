...
const eventsContent: any = {
  en: {
    ...
    intro:
      "Host your private events, family gatherings, weddings, or corporate retreats in a premium environment tailored to your needs.",
  ...
  ka: {
    ...
    sections: [
      ...
      },
      {
        ...
        icon: <Heart className="w-6 h-6 text-[#D4AF37]" />,
        text: "Tezami Villa არის სივრცე მათთვის, ვისაც სურს პირადი, ემოციური და ლამაზი ღონისძიება ზედმეტი ფორმალურობის გარეშე. ბუნებრივი გარემო, აუზი, ტერასა, ბუხარი და ინტერიერი ქმნის ფოტოგენურ ატმოსფეროს ქორწილისთვის, იუბილესთვის ან განსაკუთრებული საღამოსთვის. საჭიროების შემთხვევაში დაგეხმარებით დეკორის, მენიუს, მუსიკის, ფოტო/ვიდეო მომსახურებისა და სტუმრების ლოჯისტიკის ორგანიზებაში.",
      },
      {
